...
public class Inventoryposting {
    ...
    @Basic
    @Column(name = "C_Amount", nullable = true, precision = 4)
    ...
    @Basic
    @Column(name = "D_Amount", nullable = true, precision = 4)
    ...
    @Basic
    @Column(name = "QTY", nullable = true, precision = 4)
    ...
    @Basic
    @Column(name = "issPrice", nullable = true, precision = 4)
    ...
    public boolean equals(Object o) {
        ...
        if (issPrice != null ? !issPrice.equals(that.issPrice) : that.issPrice != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (issPrice != null ? issPrice.hashCode() : 0);
        return result;
    }
}
